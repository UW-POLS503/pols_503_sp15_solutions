...
k. The average GDP per captical of countries at least 40% Catholic countries was 1.3 times higher than those which were less than 40% Catholic.
	```{r gdpw_by_cath}
...
m. The median years of education for all countries in 1985 was 5.6 years.
	```{r median_edt_1985}
	democracy %>%
	  filter(YEAR == 1985) %>%
...
o. The median of the average years of education for democracies in 1985 was 7.8 years.
...
n. Mauritius was democracy that were closest to the median of the average years of education for all democracies in 1985 
