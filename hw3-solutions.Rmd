...
The null hypothesis for this is $H_0: \beta = 0$ and the alternative hypothesis is $H_a: \beta \neq 0$. 
...
- For all samples sizes the probability of 
- The probability of getting an error is not equal to 0.05 for the parameters which are not 0. The probability of getting a Type II error (after fixing $\alpha = 0.05$) varies with repsect to the magnitude of the parameter, and the number of observations in the sample.
